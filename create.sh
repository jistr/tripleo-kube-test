...
create_neutron() {
  ...
  # metadata-agent
  kubectl create -f services/neutron/metadata-agent-configmap.yaml
  kubectl create -f services/neutron/metadata-agent-daemonset.yaml
  ...
  # l3-agent
  kubectl create -f services/neutron/l3-agent-configmap.yaml
  kubectl create -f services/neutron/l3-agent-daemonset.yaml
